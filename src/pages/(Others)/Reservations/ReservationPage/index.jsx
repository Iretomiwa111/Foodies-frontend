...
//     e.preventDefault();
//     try {
//       await axios.post("http://localhost:5000/api/v1/reservations", formData, {
...
//         <button
//           type="submit"
//           className="w-full mt-6 bg-red-600 text-white font-semibold py-3 rounded-lg hover:bg-red-700 transition-all duration-200"
//         >
//           Confirm Reservation
//         </button>
//       </form>
