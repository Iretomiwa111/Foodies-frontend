...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#121212] text-gray-300 pt-10 pb-6 px-6 md:px-20 font-sans">
      <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-8 border-b border-gray-700 ">

        {/* Brand */}
        <div>
          <h1 className="text-3xl font-lobster text-white ">Foodies</h1>
...
<form
  ...
  className="w-full flex flex-col md:flex-row gap-3 mt-4"
>
  <input
    type="email"
    ...
    required
    className="flex-1 min-w-[250px] px-4 py-2 rounded-md border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
  />
  <button
    type="submit"
