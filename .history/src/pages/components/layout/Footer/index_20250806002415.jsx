  ...
  return (
    <footer className="bg-[#121212] text-gray-300 pt-10 pb-6 px-6 md:px-20 font-sans">
      <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-8 border-b border-gray-700 pb-8">
        ...
        {/* Brand */}
        <div>
          <h1 className="text-3xl font-lobster text-white te">Foodies</h1>
...
>
  <input
    ...
    required
    className="w-full md:w-[400px] px-4 py-2 rounded-md border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
  />
  <button
    type="submit"
