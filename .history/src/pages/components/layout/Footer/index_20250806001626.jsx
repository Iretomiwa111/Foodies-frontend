...
>
  <input
    ...
    required
    className="flex-1 w-full px-4 py-2 rounded-md border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-[200px] max-w-full"
  />
  <button
    type="submit"
