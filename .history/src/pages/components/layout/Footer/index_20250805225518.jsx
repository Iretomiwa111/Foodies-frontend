...
<form
  ...
  className="w-full max-w-lg mx-auto flex items-center justify-between gap-2"
>
  <input
    type="email"
    ...
    className="flex-1 min-w-0 px-4 py-2 rounded-md text-sm text-gray-900 placeholder-gray-500 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
  />
  <button
    type="submit"
    className="shrink-0 px-5 py-2 bg-red-600 text-white rounded-md text-sm hover:bg-red-700 transition"
  >
    Subscribe
  </button>
</form>
