...
const Footer = () => {
  ...
  className="w-full max-w-[480px] min-w-[300px] mx-auto flex flex-col sm:flex-row items-center gap-2"
>
  <input
    type="email"
    ...
    className="flex-1 min-w-0 px-4 py-2 text-sm text-gray-900 rounded-md outline-none font-lobster"
  />
  <button
    type="submit"
    className="bg-red-600 hover:bg-red-700 font-lobster text-white px-4 py-2 rounded-md text-sm whitespace-nowrap"
  >
    Subscribe
  </button>
</form>
