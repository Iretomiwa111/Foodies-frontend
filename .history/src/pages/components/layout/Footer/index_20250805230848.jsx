...
const Footer = () => {
  ...
  return (
   ...
   <form
      ...
      className="flex flex-col sm:flex-row gap-3 w-full max-w-[500px] mx-auto"
    >
      <input
        type="email"
        ...
        required
        className="px-4 py-2 rounded-md border border-gray-300 outline-none focus:ring-2 focus:ring-blue-500 flex-grow w-full"
        style={{ minWidth: "0" }}
      />
      <button
        type="submit"
