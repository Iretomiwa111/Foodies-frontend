        ...
        <div>
          ...
          >
            <input
              ...
              className="w-full px-3 py-2 text-sm text-gray-900 rounded-md outline-none font-lobster "
            />
            <button
              type="submit"
              className="bg-red-600 hover:bg-red-700 font-lobster text-white px-4 py-2 rounded-md text-sm"
            >
              Subscribe
            </button>
          </form>
