...
<form
  ...
  className="w-full max-w-md mx-auto flex flex-col sm:flex-row items-center gap-3"
>
  <input
    type="email"
    ...
    className="flex-grow w-full px-4 py-2 rounded-md text-sm text-black placeholder-gray-500 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
  />
  <button
    type="submit"
    className="px-5 py-2 rounded-md bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition-colors whitespace-nowrap"
  >
    Subscribe
  </button>
</form>
